...
function Testimonial() {
  ...
  const handleMouseEnter = (swiper, index) => {
    if (swiper.realIndex === index) {
      swiper.autoplay.stop();
    }
  };

  const handleMouseLeave = (swiper, index) => {
    if (swiper.realIndex === index) {
    ...
    <div className='sectionsGap testimonal-slider'>
      ...
      <div className="slider-container w-full overflow-hidden  lg:h-[580px]  shusma_group_home_testimonial ">
        ...
        >
          ...
          <SwiperSlide
            onMouseEnter={() => handleMouseEnter(swiperRef.current, 0)}
            onMouseLeave={() => handleMouseLeave(swiperRef.current, 0)}
          >
          ...
          <SwiperSlide
            onMouseEnter={() => handleMouseEnter(swiperRef.current, 1)}
            onMouseLeave={() => handleMouseLeave(swiperRef.current, 1)}
          >
          ...
          <SwiperSlide
            onMouseEnter={() => handleMouseEnter(swiperRef.current, 2)}
            onMouseLeave={() => handleMouseLeave(swiperRef.current, 2)}
          >
          ...
          <SwiperSlide
            onMouseEnter={() => handleMouseEnter(swiperRef.current, 3)}
            onMouseLeave={() => handleMouseLeave(swiperRef.current, 3)}
          >
          ...
          <SwiperSlide
            onMouseEnter={() => handleMouseEnter(swiperRef.current, 4)}
            onMouseLeave={() => handleMouseLeave(swiperRef.current, 4)}
          >
