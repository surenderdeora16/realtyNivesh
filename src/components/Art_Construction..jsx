    ...
    return (
        <div id='rcih' className='sectionsGap lg:container mx-auto text-center '>
            ...
            <div className='grid cmd:grid-cols-2 gap-5 lg:mt-10 mt-3 mx-3 xl:mx-0'>
                ...
                <div className='rounded-[13px] overflow-hidden sm:h-[372px] h-[250px] grid place-items-center text-white group bg-no-repeat bg-cover' style={{ backgroundImage: `url('/images/908591d6ce0a9de4cc9885a71d34cf63.png')` }}>
                ...
                <div className='rounded-[13px]  sm:h-[372px] h-[250px] grid place-items-center group overflow-hidden text-white bg-no-repeat bg-cover' style={{ backgroundImage: `url('/images/a083c685dacc3cc178999bbd2187624d.png')` }}>
                ...
                <div className='rounded-[13px] overflow-hidden sm:h-[372px] h-[250px] grid place-items-center text-white group bg-no-repeat bg-cover' style={{ backgroundImage: `url('/images/908591d6ce0a9de4cc9885a71d34cf63indusrrail.png')` }}>
                ...
                <div className='rounded-[13px]  sm:h-[372px] h-[250px] grid place-items-center group overflow-hidden text-white bg-no-repeat bg-cover' style={{ backgroundImage: `url('/images/a083c685dacc3cc178999bbd2187624dhospitaity.png')` }}>
