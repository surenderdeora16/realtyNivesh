...
import member1 from "../assets/images/be6c1d6f9d3deceef082d270ecb0fda5.png";
import member2 from "../assets/images/9c49582780f3d13e275ac5566dc36a67.png";
import member3 from "../assets/images/7a42b8662ac197bac9ce33ab327e33ac.png";
...
function BoardMember() {
    ...
    const [viewMember, setViewMember] = useState(1)

    let memberData = [
        {
            name: "Pawan kumar",
            picture: person,
            post: "Founder and Partner, Realty Nivesh",
        },
        {
            name: "Raman Sharma",
            picture: person2,
            ...
            <div className=' bg-[#F3F3F3] px-4 xs:px-6 sm:px-16 cmd:px-24'>
                <div className='w-full lg:container mx-auto lg:py-16 py-5 flex justify-between flex-wrap gap-10 lg:gap-2 '>
                    <div className='xl:w-[314px] w-full'>
                        <p className='uppercase lg:text-[40px] text-[25px] text-center xl:text-start text-[#1E6DA4] font-supera800 lg:leading-[55px]'>
                            MEET OUR
                            board MEMBER
                        </p>
                    ...
                    <div className='lg:basis-[83%] xl:basis-[50%] w-full'>
                        <div className='flex lg:justify-start justify-center items-center gap-4 lg:mb-9 mb-3 '>
                            <div className='size-[113.34px] rounded-full bg-[#1E6DA4] '>
                                <div className='w-[113.34px] h-[113.34px] cursor-pointer rounded-full overflow-hidden translate-y-2 relative'>
                                    <Image
                            ...
                            <div>
                                <p className='text-[18px] text-[#1F5B87] font-[800]'>
                                    {memberData[viewMember]?.name}
                                </p>
                                <p className='text-[15.66px] text-[#686868] font-medium tracking-wide capitalize'>{memberData[viewMember]?.post}</p>
                            </div>
                        </div>
                        <div className=' bg-[#1E6DA4] w-[300px] xs:w-[100%] mx-auto  rounded-[9px] lg:px-12 px-5 lg:py-9 py-4 sm:py-5 sm:px-8 font-supera400 tracking-[1.2px] md:tracking-wide text-[12px] sm:text-[13px] md:text-[15px] lg:text-[17px] text-white mt-5 lg:mt-0'>
                            <p className='flex flex-col gap-y-4'>{memberData[viewMember]?.name == 'Pawan kumar' &&
                                <span>
                            ...
                            <p className='flex flex-col gap-y-2'>{memberData[viewMember]?.name == 'Raman Sharma' &&
                                <span>
                    ...
                    <div className='lg:basis-[5%] w-full lg:space-y-4 lg:block flex justify-between xs:justify-evenly'>
                        {
                            memberData.map((item, index) => (
                                <div key={index} className={` lg:size-[132px] cursor-pointer size-[100px]  rounded-full grid place-items-center ${viewMember == index ? "border-[3px] border-[#1E6DA4]" : ""}`} onClick={() => setViewMember(index)}>
