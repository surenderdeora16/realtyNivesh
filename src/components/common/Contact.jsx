                                    ...
                                    <div className='w-[90%] md:w-[85%] h-full grid grid-cols-2 grid-flow-row mx-auto  gap-x-[15px] gap-y-3 mt-10'>
                                        ...
                                        <div className='col-span-2 '>
                                            <div className='mt-1 pr-2 w-full h-[44px] bg-[#11508F] border-[0.74px] border-[#F2F9FF] rounded-[6px]'>
                                                <Field component="select" name="preferredHomeSize" className='cursor-pointer w-full h-full bg-transparent outline-none px-5 text-[#909090]  font-supera500 text-[14px]' >
                                        ...
                                        <div className='col-span-2 '>
                                            <div className='mt-1 pr-2 w-full h-[44px] bg-[#11508F] border-[0.74px] border-[#F2F9FF] rounded-[6px]'>
                                                <Field component="select" name="broker" className='cursor-pointer w-full h-full bg-transparent outline-none px-5 text-[#909090] font-supera500 text-[14px]' >
                                        ...
                                        <div className='col-span-2 '>
                                            <div className='mt-1 pr-2 w-full h-[44px] bg-[#11508F] border-[0.74px] border-[#F2F9FF] rounded-[6px]'>
                                                <Field component="select" name="howHeardAboutUs" className='cursor-pointer w-full h-full bg-transparent outline-none px-5 text-[#909090] font-supera500 text-[14px]' >
