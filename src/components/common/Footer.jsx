...
function Footer() {
    ...
    return (
        <div className='sectionsGap'>
            <div className='w-full bg-[#3A3A3A] pt-[60px]  pb-[15px]'>
                <div className='lg:container mx-auto'>
                    <Link href="/">
                        <div className='max-w-[250px] cmd:max-w-[330px] mx-auto relative'>
                            <Image
                                src={logo}
                                alt="footer-logo"
                                layout="responsive"
                                width={250} // Adjust to the max-width value
                    ...
                    <div className='flex flex-col gap-y-[38px]'>
                        <ul className='flex justify-center flex-wrap lg:flex-nowrap gap-3 md:gap-x-6 lg:gap-x-6 xl:gap-x-7 2xl:gap-x-9 px-2 sm:px-0'>
                            ...
                            <Link href="#what-we-do">
                                <li className=' text-[12px] cmd:text-[14px] lg:text-[13px] 2xl:text-[15px] 3xl:text-[16px] font-supera500 text-white uppercase tracking-wide'>Our Services</li>
                            </Link>
                            <Link href="#rcih">
                                <li className=' text-[12px] cmd:text-[14px] lg:text-[13px] 2xl:text-[15px] 3xl:text-[16px] font-supera500 text-white uppercase tracking-wide'>Residential</li>
                            </Link>
                            <Link href="#rcih">
                                <li className=' text-[12px] cmd:text-[14px] lg:text-[13px] 2xl:text-[15px] 3xl:text-[16px] font-supera500 text-white uppercase tracking-wide'>Commercial</li>
                            </Link>
                            <Link href="#rcih">
                                <li className=' text-[12px] cmd:text-[14px] lg:text-[13px] 2xl:text-[15px] 3xl:text-[16px] font-supera500 text-white uppercase tracking-wide'>Industrial</li>
                            </Link>
                            <Link href="#rcih">
                                <li className=' text-[12px] cmd:text-[14px] lg:text-[13px] 2xl:text-[15px] 3xl:text-[16px] font-supera500 text-white uppercase tracking-wide'>Hospitality</li>
                            </Link>
                            <Link href="#associate-builders">
                                <li className=' text-[12px] cmd:text-[14px] lg:text-[13px] 2xl:text-[15px] 3xl:text-[16px] font-supera500 text-white uppercase tracking-wide'>Associated builders</li>
                            </Link>
                        ...
                        <div className='flex justify-around cxs:justify-center flex-wrap cxs:flex-nowrap gap-y-6 cxs:gap-y-0 gap-x-4 sm:gap-x-10 px-2 cxs:px-0'>
                            ...
                            <div onClick={() => window.location.href = 'tel:919988010405'}  className='cursor-pointer flex items-center  gap-2.5'>
                                <span className=''>
                            ...
                            <div onClick={() => window.location.href = 'tel:918968066698'} className='cursor-pointer flex items-center  gap-2.5'>
                                <span className=''>
                                    <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M14.4089 8.28773H16.0963C16.0963 3.95957 12.8287 0.695312 8.49463 0.695312V2.3827C11.9217 2.3827 14.4089 4.8657 14.4089 8.28773Z" fill="white" />
                                        <path d="M8.50262 5.75793C10.2769 5.75793 11.0337 6.51473 11.0337 8.28902H12.7211C12.7211 5.5681 11.2235 4.07054 8.50262 4.07054V5.75793ZM11.3897 10.3502C11.2276 10.2028 11.0146 10.1242 10.7956 10.131C10.5766 10.1378 10.3689 10.2294 10.2162 10.3864L8.1972 12.4628C7.71123 12.37 6.73424 12.0654 5.72855 11.0622C4.72287 10.0557 4.41829 9.07619 4.32802 8.59359L6.40266 6.57379C6.55994 6.42119 6.65167 6.21338 6.65844 5.99434C6.66521 5.77531 6.58649 5.56223 6.43894 5.40021L3.32149 1.97227C3.17388 1.80974 2.96872 1.71115 2.74959 1.69745C2.53046 1.68374 2.31462 1.756 2.14791 1.89887L0.317089 3.46899C0.171223 3.61538 0.084161 3.81022 0.0724171 4.01655C0.0597617 4.22747 -0.181535 9.22383 3.69271 13.0998C7.07256 16.4788 11.3062 16.726 12.4722 16.726C12.6426 16.726 12.7473 16.7209 12.7751 16.7192C12.9814 16.7077 13.1761 16.6202 13.3218 16.4737L14.8911 14.642C15.0341 14.4754 15.1065 14.2597 15.0929 14.0405C15.0794 13.8214 14.9809 13.6162 14.8185 13.4685L11.3897 10.3502Z" fill="white" />
