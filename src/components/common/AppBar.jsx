                                ...
                                <div className={` ${explore ? 'opacity-100 z-40 duration-[1ms] backdrop-blur-sm bottom-[-12%]  left-0' : 'duration-75 left-[100%] opacity-0 z-10  '} overlay-animation  fixed  overflow-hidden h-screen w-screen  bg-[#000000aa] `}>
                                    <div className='w-full h-full flex justify-center items-end py-9'>
                                        <div className={`${explore ? 'w-[200px] h-[200px] opacity-100 duration-500' : 'opacity-0 w-[55px] h-[55px] duration-500'}  relative rotate-[24deg] flex justify-between items-center rounded-full`}>
                                            <Link onClick={() => setExplore(false)} href="/" className='rotate-[-24deg] absolute top-[-10%] left-[18%] w-[70px] h-[70px] bg-[#fff] rounded-full flex justify-center items-center'>
                                                <div className='w-full h-full rounded-full relative flex justify-center items-center'>
                                                    ...
                                                    <h6 className='uppercase text-[13px] font-supera600 text-[#fff] text-center tracking-[1px] absolute top-[110%] left-[50%] translate-x-[-50%]'>Commercial </h6>
                                                </div>
                                            </Link>
                                            ...
                                            <Link onClick={() => setExplore(false)} href="/" className='rotate-[-24deg] absolute top-[-6%] left-[82%] w-[70px] h-[70px] bg-[#fff] rounded-full flex justify-center items-center'>
                                                <div className='w-full h-full rounded-full relative flex justify-center items-center'>
                                                    ...
                                                    <h6 className='uppercase text-[13px] font-supera600 text-[#fff] text-center tracking-[1px] absolute top-[110%] left-[50%] translate-x-[-50%]'>upcoming</h6>
                                                </div>
                                            </Link>
                                            <Link onClick={() => setExplore(false)} href="/" className='rotate-[-24deg] absolute top-[40%] left-[-24%] w-[70px] h-[70px] bg-[#fff] rounded-full flex justify-center items-center'>
                                                <div className=' w-full h-full rounded-full relative flex justify-center items-center'>
                                                    ...
                                                    <h6 className=' uppercase text-[13px] font-supera600 text-[#fff] text-center tracking-[1px] absolute top-[110%] left-[50%] translate-x-[-50%]'>RESIDENTIAL</h6>
                                                </div>
                                            </Link>
                                        </div>
                                    </div>
