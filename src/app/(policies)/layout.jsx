...
export default function RootLayout({ children }) {
    ...
    return (
        <React.Fragment>
            <header className="bg-[#1E6DA4] text-white h-[30vh] flex items-center justify-center">
            ...
            <footer className="bg-[#1E6DA4] text-white py-4">
                <p className="text-center font-lato text-[#c8c8c8] tracking-wide font-bold text-[10px] cxs:text-[13px] sm:text-[10px] cmd:text-[13px] lg:text-[15px] capitalize">
                    © Copyright 2024 Sushma Elementa. Realty Nivesh. All Rights Reserved.
                </p>
            </footer>
        </React.Fragment>
    );
